...
public class FareServiceImpl implements FareService {
    ...
    @Transactional
    public OrderMsg getParkingMsgToOrder(int timeId) throws Exception {
        return parkingTimeMapper.findOneTimes(timeId);
    }
    ...
    public void addOrder(Order order) throws Exception {
        fareMapper.addOrderById(order);
    }

    @Transactional
    public AllOrderMsg getOrder(int timeId) throws Exception {
        return fareMapper.getOrder(timeId);
    }
    ...
    @Transactional
    public List<ParkingRecord> getParkingRecords(int driverId) throws Exception {
        return fareMapper.getParkingRecords(driverId);
    }
